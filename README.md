...
_Внимание: На вариантах чипов с макрикровкой в первой строке "PHY6222" без "QC" BLE соединение нестабильно при напряжении питания более 2.5В! Ищется решение этой проблемы..._
